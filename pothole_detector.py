...
h5f_data = h5py.File('E:/Python3.7/projects/pothole detection/output/data.h5', 'r')
h5f_label = h5py.File('E:/Python3.7/projects/pothole detection/output/labels.h5', 'r')
